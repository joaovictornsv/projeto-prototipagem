...
import {createWeighing, getLicensePlateInfo, verifyInvoiceNumber} from "../../utils/api.js";
  ...
  return (
    <div className="w-full flex flex-col gap-12">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-center">Sistema de pesagem</h1>
      </div>

      <div className="flex flex-col gap-4 items-start">
        <h1 className="text-2xl font-medium text-center">Motorista</h1>
      ...
      <div className="flex flex-col gap-4 items-start">
        <h1 className="text-2xl font-medium text-center">Veículo</h1>
      ...
      <div className="flex flex-col gap-4 items-start">
        <h1 className="text-2xl font-medium text-center">Nota fiscal</h1>
        <div className="flex flex-col gap-4 w-full">
          <div className="flex items-end gap-4">
            <Input
